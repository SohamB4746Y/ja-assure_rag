...
def _extract_city(risk_location: str) -> str:
    """Handle extract city for this module.
...
class AnalyticalEngine:
    ...
    def __init__(self, decoded_df=None, metadata: list[dict] = None):
        ...
        Args:
            decoded_df: Input used to execute this operation.
    ...
    def get_record_count(self) -> int:
        """Return record count for the current workflow.
    ...
    def get_unique_quote_ids(self) -> List[str]:
        """Return unique quote ids for the current workflow.
    ...
    def _fmt_top_insured(self, data: List[Dict]) -> str:
        """Handle fmt top insured for this module.
        
        Args:
            data: Input used to execute this operation.
    ...
    def _fmt_above_threshold(self, data: List[Dict], threshold: float) -> str:
        """Handle fmt above threshold for this module.
        
        Args:
            data: Input used to execute this operation.
            threshold: Input used to execute this operation.
    ...
    def _fmt_industry_totals(self, data: List[Dict]) -> str:
        """Handle fmt industry totals for this module.
    ...
    def _fmt_security_features(self, data: List[Dict]) -> str:
        """Handle fmt security features for this module.
    ...
    def _fmt_gps_stats(self, data: Dict) -> str:
        """Handle fmt gps stats for this module.
    ...
    def _fmt_claim_stats(self, data: List[Dict]) -> str:
        """Handle fmt claim stats for this module.
    ...
    def _fmt_claim_ratio(self, data: Dict) -> str:
        """Handle fmt claim ratio for this module.
    ...
    def _fmt_company_policy_counts(self, data: List[Dict]) -> str:
        """Handle fmt company policy counts for this module.
    ...
    def _fmt_average_claim_amount(self, data: Dict) -> str:
        """Handle fmt average claim amount for this module.
    ...
    def _fmt_underwriting_tat(self, data: Dict) -> str:
        """Handle fmt underwriting tat for this module.
    ...
    def _fmt_regions_by_claim_frequency(self, data: List[Dict], ascending: bool) -> str:
        """Handle fmt regions by claim frequency for this module.
        
        Args:
            data: Input used to execute this operation.
            ascending: Input used to execute this operation.
