...
class CompoundQueryHandler:
    ...
    """Encapsulates compound query handler for this subsystem."""
    FIELD_PHRASE_MAP = [
    ...
    def _extract_condition_filters(self, q: str) -> List[Tuple[str, str]]:
        ...
        def _is_negative_phrase(phrase: str) -> bool:
            """Handle is negative phrase for this module.
            
            Args:
                phrase: Input used to execute this operation.
