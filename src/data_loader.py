...
Provides the core logic for data loader.
"""
...
def parse_json(cell):
    ...
    Args:
        cell: Input used to execute this operation.
...
def build_document(row) -> dict:
    """Build document using the given inputs.
    
    Args:
        row: Input used to execute this operation.
...
def load_documents(excel_path: str):
    ...
    Args:
        excel_path: Input used to execute this operation.
