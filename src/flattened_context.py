"""Flattened context module.

Provides the core logic for flattened context.
"""
...
def _to_float(value: Any) -> float:
    """Handle to float for this module.
...
def _is_positive_number(value: Any) -> bool:
    """Handle is positive number for this module.
...
def _to_bool(value: Any) -> bool:
    """Handle to bool for this module.
...
def _labelize_sum_key(key: str) -> str:
    """Handle labelize sum key for this module.
